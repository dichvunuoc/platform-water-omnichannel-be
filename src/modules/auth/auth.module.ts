...
// Provider linking (Zalo/Google/Facebook/Apple) is handled by better-auth's OAuth
// flow; the BFF issues the authorization URL and better-auth links the provider on callback.
